...
define([
    ...
    return Select.extend({
        ...
        initConfig: function () {
            ...
            if (stores
                && pickupData().website_id !== window.checkoutConfig.amastyStorePickupConfig.websiteId
                || pickupData().store_id !== window.checkoutConfig.amastyStorePickupConfig.storeId
            ) {
        ...
        storeObserver: function (storeId) {
            if (storeId && this.value() != storeId) { //eslint-disable-line eqeqeq
                this.value(storeId);
            }
        },
