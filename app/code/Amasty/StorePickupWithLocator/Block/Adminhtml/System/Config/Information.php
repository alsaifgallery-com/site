...
class Information extends Fieldset
{
     ...
     * @var string
     */
    private $userGuide = 'https://amasty.com/docs/doku.php?id=magento_2:store_pickup_with_locator&utm_source=extension'
    . '&utm_medium=backend&utm_campaign=store-pickup-with-locator';
