...
class Shipping extends AbstractCarrier implements CarrierInterface
{
    ...
    public function collectRates(RateRequest $request)
    {
        ...
        if (!$this->isExistAvailableLocation()) {
            return false;
        }
     ...
     * @return bool
     */
    private function isExistAvailableLocation()
    {
        return (bool)!$this->checkoutSession->getStepData('checkout', LocationProvider::NO_AVAILABLE_LOCATIONS);
    }
}
