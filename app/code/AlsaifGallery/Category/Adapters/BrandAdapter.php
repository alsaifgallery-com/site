...
class BrandAdapter implements BrandAdapterInterface {
    ...
    public function getBrands() {
      // return $this->brandList->getCollection();  
      // return $this->brandList->getAlphaBet();  
      return $this->brandFeatured->getFeaturedBrand();  
    }
    
    public function getAllBrands(){
      return  $this->helper->getBrandList(); 
    }
    
    
     public function getBrandsByIds( $brandIds ){
         $col = $this->helper->getBrandList( "category", $brandIds );
         return $col;
     }
