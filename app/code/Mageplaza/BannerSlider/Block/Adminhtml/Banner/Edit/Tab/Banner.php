...
class Banner extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $titleBanner = $fieldset->addField('target', 'text', [
            'name'  => 'target',
            'label' => __('Banner target'),
            'title' => __('Banner target'),
        ]);

        $targetId = $fieldset->addField('target_id', 'text', [
            'name'  => 'target_id',
            'label' => __('Target ID'),
            'title' => __('Target ID'),
        ]);
        ...
        $dependencies = $this->getLayout()->createBlock(Dependence::class)
            ...
            ->addFieldMap($targetId->getHtmlId(), $targetId->getName())
            ...
            ->addFieldDependence($targetId->getName(), $typeBanner->getName(), '0')
