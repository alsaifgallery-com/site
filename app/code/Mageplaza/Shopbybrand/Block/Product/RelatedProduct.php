...
class RelatedProduct extends ListProduct
{
    ...
    /**
     * @return \Magento\Catalog\Model\ResourceModel\Product\Collection|\Magento\Eav\Model\Entity\Collection\AbstractCollection|\Magento\Framework\Data\Collection\AbstractDb|null
     * @throws \Magento\Framework\Exception\NoSuchEntityException
     */
    protected function _getProductCollection()
    {
        if ($this->getRequest()->isAjax() && ($this->_request->getFullActionName() == 'mpbrand_index_view') && $this->getRequest()->getParam('title')) {
