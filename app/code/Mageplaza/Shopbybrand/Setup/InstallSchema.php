    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (!$installer->tableExists('mageplaza_brand')) {
            $table = $installer->getConnection()
                ...
                ->addColumn('option_id', Table::TYPE_INTEGER, null, ['unsigned' => true, 'nullable' => false], 'Attribute Option Id')
                ->addColumn('store_id', Table::TYPE_INTEGER, null, ['nullable' => false, 'default' => '0'], 'Config Scope Id')
