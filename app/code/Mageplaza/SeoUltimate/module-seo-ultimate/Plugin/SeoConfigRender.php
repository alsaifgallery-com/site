...
class SeoConfigRender
{
     ...
     * @return mixed
     */
    public function aroundRender(\Magento\Config\Block\System\Config\Form\Field $subject, callable $proceed, \Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
