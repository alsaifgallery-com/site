...
{
    /**
     * @type \Magento\Catalog\Model\ProductFactory
     */
    ...
    /**
     * @type \Magento\Catalog\Model\CategoryFactory
     */
    ...
    public function reloadMediateTable($entity, $type)
    {
        ...
        foreach ($this->getAllStoreId() as $storeId) {
            ...
            } else if ($type == self::PRODUCT_ENTITY) {
    ...
    public function mappingPage()
    {
        ...
        /** @type \Magento\Cms\Model\Page $page */
    ...
    public function mappingCategory()
    {
        ...
        /** @type \Magento\Catalog\Model\Category $category */
