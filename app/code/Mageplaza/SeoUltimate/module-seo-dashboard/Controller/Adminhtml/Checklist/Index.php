...
class Index extends Action
{
    ...
    /**
     * @var \Mageplaza\SeoDashboard\Helper\Checklist\Robot
     */
    protected $_robot;

    /**
     * @var \Mageplaza\SeoDashboard\Helper\Checklist\SiteMap
     */
    protected $_siteMap;

    /**
     * @var \Mageplaza\SeoDashboard\Helper\Checklist\Homepage
     */
    protected $_homepage;
    ...
    public function checkRobotDisallow()
    {
        ...
        if (!$this->_robot->checkRobotDisallow()) {
            $this->message(HelperConfig::ERROR, __('Your robots.txt file disallow Search Engine index your store. Please check yourdomain.com/robots.txt file for more information.'));
        }
    ...
    public function hasSiteMapFile()
    {
        ...
        if ($this->_siteMap->hasSiteMapFile()) {
            ...
            $this->message(HelperConfig::WARNING, __('We recommend that you should add sitemap.xml in Magento directory.'));
        }
    ...
    public function checkHomepage()
    {
        if ($this->_homepage->checkHomepage($this->getStoreId())) {
            ...
            $this->message(HelperConfig::WARNING, __(
                    ...
                    $this->getUrl('cms/page/index'), $this->getUrl('adminhtml/system_config/edit/section/web') . '#web_default-head'
                )
            );
        }
    ...
    public function checkRobotSiteMap()
    {
        ...
        if ($this->_robot->hasRobotSiteMap()) {
            ...
            $this->message(HelperConfig::WARNING, __('We recommend you add Sitemap URL in robots.txt file or add submit sitemap to Google Search Console / Webmaster Tools.'));
        }
