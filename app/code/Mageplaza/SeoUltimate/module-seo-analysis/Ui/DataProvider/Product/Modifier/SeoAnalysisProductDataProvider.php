...
class SeoAnalysisProductDataProvider extends AbstractModifier
{
    ...
    public function modifyData(array $data)
    {
        if ($this->isEnableSeoAnalysis()) {
            ...
            $reviewLabel   = $this->getReviewsCount() > 1 ? __('%1 Reviews', $this->getReviewsCount()) : __('%1 Review', $this->getReviewsCount());
    ...
    {
        if ($this->isEnableSeoAnalysis()) {
            $this->setFieldSearchEngineOptimization($meta, 'meta_title', self::EXTEND_IMPORT_HANDLER_COMPONENT, self::FIELD_PROGRESS_TEMPLATE);
            $this->setFieldSearchEngineOptimization($meta, 'meta_description', self::EXTEND_IMPORT_HANDLER_COMPONENT, self::FIELD_PROGRESS_TEMPLATE);
            $this->setFieldSearchEngineOptimization($meta, 'mp_meta_data_preview', self::EXTEND_ELEMENT_ABSTRACT_COMPONENT, self::FIELD_META_DATA_PREVIEW_TEMPLATE);
            $this->setFieldSearchEngineOptimization($meta, 'mp_seo_insights', self::EXTEND_ELEMENT_ABSTRACT_COMPONENT, self::FIELD_SEO_INSIGHTS_TEMPLATE);
            $this->setFieldSearchEngineOptimization($meta, 'url_key', self::EXTEND_ELEMENT_ABSTRACT_COMPONENT, self::FIELD_INPUT_TEXT_TEMPLATE);
            $this->setFieldSearchEngineOptimization($meta, 'mp_main_keyword', self::EXTEND_ELEMENT_ABSTRACT_COMPONENT, self::FIELD_INPUT_TEXT_TEMPLATE);
