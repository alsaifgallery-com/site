...
class Index extends Action
{
    ...
    public function execute()
    {
        if (!$this->helperData->isEnabled()) {
            $this->messageManager->addWarning(__('Mageplaza SEO extension is being disabled, so Terms will be not applied. Please enable it  <a href="%1">here</a>', $this->getUrl('adminhtml/system_config/edit/section/seo')));
        }
