...
class Label extends Deal
{
    ...
    {
        return $this->_helperData->getConfigGeneral('discount_label/show_discount_label');
    }
    ...
    {
        return $this->_helperData->getConfigGeneral('discount_label/label_border_color');
    }
    ...
    public function getLabel($percent)
    {
        ...
        $label = $contentLabel ? $contentLabel : '{{number}}';
    ...
    /**
     * Check postion label = bottom image
     *
     * @return bool
     */
    public function isLabelBottom()
    {
        return $this->getLocationLabelOnImage() == ShowOnProductImage::BOTTOM_LEFT || $this->getLocationLabelOnImage() == ShowOnProductImage::BOTTOM_RIGHT;
    }
}
