...
class LayoutProcessor implements \Magento\Checkout\Block\Checkout\LayoutProcessorInterface
{
    ...
    public function process($jsLayout)
    {
        ...
        /*Shipping mobile*/
        $telephoneData = $jsLayout['components']['checkout']['children']['shippingAddress']['children']['shipping-address-fieldset']['children']['phone-company-field-row']['children']['telephone']['config'];
        ...
        $jsLayout['components']['checkout']['children']['shippingAddress']['children']['shipping-address-fieldset']['children']['phone-company-field-row']['children']['telephone']['config'] = $telephoneData;
        return $jsLayout;
    }
}
