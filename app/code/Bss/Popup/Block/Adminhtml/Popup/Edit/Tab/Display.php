    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'note' => __("Enter IDs of Categories to be excluded from the Display Rule. Example: 3,4,5")
            ]
        );
        ...
        $fieldset->addField(
            ...
            [
                ...
                'note' => __("Enter IDs of Products to be excluded from the Display Rule. Example: 3,4,5")
            ]
        );
